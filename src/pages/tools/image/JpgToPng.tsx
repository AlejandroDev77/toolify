...
export default function JpgToPng() {
  ...
  const handleFileSelect = (selectedFile: File) => {
    ...
    if (!selectedFile.type.includes('jpeg') && !selectedFile.type.includes('jpg')) {
      setError(t('common.pleaseUploadValidJPG'));
      return;
    }
  ...
  const handleDownload = () => {
    ...
    link.download = `convertido-${file?.name.replace(/\.jpe?g$/i, '.png') || 'imagen.png'}`;
    link.click();
  };
  ...
  return (
    <>
      <SEO {...seoConfig.jpgToPng} />
      <ToolLayout
        title="JPG → PNG"
        description="Convierte imágenes JPG a formato PNG en alta calidad con soporte para transparencia."
      >
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl mx-auto mb-8">
              <div className="flex flex-col items-center">
                <span className="text-sm font-semibold text-gray-500 mb-3 uppercase tracking-wider">Original (JPG)</span>
              ...
              <div className="flex flex-col items-center">
                <span className="text-sm font-semibold text-gray-500 mb-3 uppercase tracking-wider">Resultado (PNG)</span>
                <div className="relative w-full aspect-square border-2 border-dashed border-gray-200 rounded-xl overflow-hidden bg-gray-50 flex items-center justify-center">
                  {convertedUrl ? (
                    ...
                    <div className="text-gray-400 text-sm flex flex-col items-center gap-2">
                       ...
                       <p>{t('common.waitingConversion')}</p>
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              ...
              {!convertedUrl ? (
                ...
                >
                  ...
                  {isConverting ? 'Convirtiendo...' : 'Convertir a PNG'}
                </button>
              ) : (
                <button
