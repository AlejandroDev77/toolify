    ...
    <HelmetProvider>
      <BrowserRouter>
        <Layout>
          ...
          <Route path="/tool/discount-calculator" element={<DiscountCalculator />} />
          ...
          <Route path="/tool/investment-calculator" element={<InvestmentCalculator />} />
          ...
          <Route path="/tool/profit-margin-calculator" element={<ProfitMarginCalculator />} />
          <Route path="/tool/break-even-calculator" element={<BreakEvenCalculator />} />
          <Route path="/tool/body-fat-calculator" element={<BodyFatCalculator />} />
          <Route path="/tool/ideal-weight-calculator" element={<IdealWeightCalculator />} />
          <Route path="/tool/water-intake-calculator" element={<WaterIntakeCalculator />} />
          <Route path="/tool/macro-calculator" element={<MacroCalculator />} />
          <Route path="/tool/retirement-calculator" element={<RetirementCalculator />} />
          ...
          <Route path="/tool/username-generator" element={<UsernameGenerator />} />
          <Route path="/tool/hashtag-generator" element={<HashtagGenerator />} />
          <Route path="/tool/slogan-generator" element={<SloganGenerator />} />
          ...
          <Route path="/tool/remove-duplicates" element={<RemoveDuplicates />} />
